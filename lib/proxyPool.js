...
// ESM-compliant named exports for all ProxyPool methods
export const initProxyPool = (configOrOptions = {}) => {
  proxyPool.init(configOrOptions);
  return proxyPool.fetchProxies(true);
};
export const fetchProxies = (force = false) => proxyPool.fetchProxies(force);
export const validateAllProxies = (isNewFetch = false) => proxyPool.validateAllProxies(isNewFetch);
export const getNextProxy = () => proxyPool.getNextProxy();
export const getProxyStats = () => proxyPool.getStats();