...
module.exports = {
  initTor: (torConfig) => torManager.initTor(torConfig),
  checkTorStatus: () => torManager.checkTorStatus(),
  getCurrentIp: () => torManager.getCurrentIP(),
  rotateIP: () => torManager.rotateIP(),
  getProxyAgent: () => torManager.getProxyAgent(),
  getProxyConfig: () => torManager.getProxyConfig(),
  getTorStats: () => torManager.getStats(),
  cleanup: () => torManager.cleanup()
}; 